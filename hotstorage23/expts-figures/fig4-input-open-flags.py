...
# 'green' 'orange'
ax.barh(x_labels, data[0], color='#4daf4a', edgecolor='black', linewidth=0.5, label='CrashMonkey')
ax.barh(x_labels, data[1], color='#ff7f0e',  edgecolor='black', linewidth=0.5, left=data[0], hatch='////', label='xfstests')
