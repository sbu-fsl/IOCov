...
#define PanSource	"loop-prob.pml"
...
#define _nstates1	11	/* driver */
#define minseq1	14
#define maxseq1	23
#define _endstate1	10

#define _nstates0	15	/* worker */
#define minseq0	0
#define maxseq0	13
...
#define Pdriver	((P1 *)_this)
typedef struct P1 { /* driver */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, open_flags) - 1*sizeof(int))
